...
As of 2025/6, a fork of FA2SP was released, called FA2HDM. This adds a large amount of new features, including:
...
| Topic | Source + Link |
| ------------ | ------------- |
| FA2HDM [Mods] | [Github - Main Page](https://github.com/handama/FA2sp)|
| FA2HDM [Mods] | [Github - Releases](hhttps://github.com/handama/FA2sp/releases)|
